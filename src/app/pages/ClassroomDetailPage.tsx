...
export function ClassroomDetailPage() {
  ...
  return <ClassroomWorkspaceContainer className="lg:overflow-hidden">
    ...
    <section aria-label="강의실 통합 콘텐츠" className="grid items-start gap-4 md:min-h-[600px] lg:min-h-0 lg:flex-1 lg:grid-cols-[260px_minmax(0,1fr)] lg:grid-rows-[minmax(0,1fr)] lg:items-stretch">
